...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("DCNN denoising performance test")
    print("=" * 60)
    ...
    for sigma_noise in sigma_list:
        ...
        if sigma_noise == 5:
            ...
            plt.plot(
                ...
                "b-",
                linewidth=0.8,
                label=f"DCNN Residual (Var: {np.var(error_denoised):.4f})",
            )
            plt.xlabel("Time (s)")
            ...
            plt.show()
            print("Saved figure: dcnn_time_domain_result.png")

    print("\n" + "=" * 60)
    print("DCNN denoising summary")
    print("=" * 60)
